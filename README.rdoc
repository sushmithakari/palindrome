...
For testing we use light modifications of a literary sample provided by {Gutenberg}[http://www.gutenberg.org] and we also have a lightly modified version of the {sample genetic sequence}[http://fasta.bioch.virginia.edu/cshl/stubbs/data/ZNF286A_fdr0_summits_seq.fa] provided by UVA.
